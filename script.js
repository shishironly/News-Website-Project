const api = '6387b904192945dea3114e5927b83a69';
...
function fillDataInCard(cardClone, article) {
    ...
    newsSource.innerHTML = `${article.source.name} &bull; ${date}`;
...
searchButton.addEventListener('click', () => {
    ...
    if (!query) return;  //if query is empty return nothing else fetchNews
    fetchNews(query);
